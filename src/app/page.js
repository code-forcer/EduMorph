...
import illustration from '/public/six.jpg'; // Ensure the illustration is in the public folder
    ...
    <>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.illustration}>
          <Image src={illustration} alt="Illustration of person studying on computer" style={{borderRadius:'5px'}} width={150} height={150} />
        </div>
